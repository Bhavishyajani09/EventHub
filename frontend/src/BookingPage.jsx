        ...
        <div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              {[
                { name: 'COKE MEDIUM', price: '₹340', image: '🥤' },
                { name: 'Large Coke', price: '₹440', image: '🥤' },
                { name: 'COKE REGULAR', price: '₹300', image: '🥤' },
                { name: 'Garden Fresh Veggie Sandwich in Focaccia', price: '₹300', image: '🥪' }
              ].map((item, index) => (
                <div key={index} style={{
